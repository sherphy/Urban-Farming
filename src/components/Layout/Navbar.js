    ...
    return (
        ...
        <AppBar position="static" sx={{background: '#FFA500'}}>
          <Toolbar>
            ...
            <Button variant="contained" className={classes.logoutbutton}>Logout</Button>
          </Toolbar>
          <Drawer classes={{paper: classes.drawerPaper,}} open={OpenDrawer} onClose={()=>setOpenDrawer(false)}>
                <List>
                <Stack spacing={12}>
                  <Button variant="contained" size="large" onClick={handleDrawerClose} component={Link} to="/signup">Signup</Button>
